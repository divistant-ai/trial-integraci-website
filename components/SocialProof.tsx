      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 opacity-60 grayscale">
          {partners.map((partner, index) => (
            <div
              key={index}
              className="px-6 py-3 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700"
            >
              <span className="text-gray-700 dark:text-gray-300 font-medium">{partner}</span>
            </div>
          ))}
        </div>
      </div>
